...
admin_route.post(
  ...
  pdtController.addProductDetails
);
admin_route.get("/editProduct/:id", pdtController.loadEditProduct);
admin_route.post(
  "/editProduct/",
  upload.array("image", 3),
  pdtController.postEditProduct
);
...
admin_route.post(
  ...
  ctgryController.removeCategoryOffer
);
...
admin_route.post(
  ...
  pdtController.removeProductOffer
);
