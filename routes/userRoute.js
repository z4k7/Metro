...
user_router.get('/shoppingCart/proceedToCheckout',orderController.loadCheckout)
...
user_router.get('/removeWishlistItem/:productId',userController.removeWishlistItem)
...
user_router.post('/profile/addAddress/:returnPage',addressController.postAddAddress)
...
// user_router.get('/profile/forgotPassword',userController.forgotPassword) 
// user_router.post('/profile/forgotPasswordVerification',userController.verifyOTPforgotPass)
// user_router.get('/profile/resetPassword',userController.loadResetPassword)
// user_router.post('/profile/resetPassword', userController.postResetPassword)
...
user_router.get('/viewOrderDetails/:orderId',orderController.loadViewOrderDetails)
user_router.get('/cancelOrder/:orderId',orderController.cancelOrder)
user_router.get('/cancelSinglePrdt/:orderId/:pdtId',orderController.cancelSinglePdt)
user_router.get('/returnOrder/:orderId',orderController.returnOrder)
user_router.get('returnSinglePrdt/:orderId/:pdtId',orderController.returnSinglePdt)
